...
namespace MyFirstCSharp.Lesson05_Class
{
    ...
    //   . 클래스는 상속을 받을 때 단 하나의 부모 클래스만 설정 할 수 있다
    ...
    // MyClass 1 과 MyClass 2 의 기능을 모두 상속 받아서 사용하고 싶을때
    //class MyNewClass : MyClass1, MyClass2
    //{
    //    // MyClas
    //    s1 에서 실행을 해야 할지, MyClass2 에서 실행을 해야할지 모호
    ...
    class Wordmanagement : DataBaseManagement, IWordManage, Iextract
    {
        ...
        class NewClass_
        {
            public NewClass_()
            {
                ...
                // DataBaseManagement 가 강제한 기능만 실행 할 수 있다
