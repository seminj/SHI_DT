...
router.get('/list/:pg', async function(req, res, next) {
    ...
    if(searchGb == "1")
      ...
      condition = "and title like '%" + searchText + "%' or "
    ...
    let searchGbTitle="선택하세요";
    if(searchGb!="")
     searchGbTitle=titles[searchGb];

    res.render( "board/board_list", {boardList:boardList, paging:paging,
                  searchGb:searchGb, searchText:searchText, searchGbTitle:searchGbTitle});
});
