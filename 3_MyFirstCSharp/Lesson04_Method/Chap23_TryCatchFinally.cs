...
namespace MyFirstCSharp
{
    ...
    public partial class Chap23_TryCatchFinally : Form
    {
        ...
        {
            //  try 와 catch 는 반드시 한쌍으로 구현 되어야 한다.
            try
            {
                string sMessage = "Try"; 
            ...
            {
                // finally 구문은 try 와 catch 의 마지막에 구현 된다. 
                // 반드시 구현되어야 하는 구문은 아니다.
                // - Try(정상로직 이 실행되는 경우) 와
                //   catch (예외 상황의 로직이 실행되는 경우)
                //   에 관계 없이 반드시 실행 되어야 하는 로직이 구현되는 곳.
        ...
        private void btnThrow_Click(object sender, EventArgs e)
        {
            ...
            // 0 ~ 10 난수 를 받아 서 5 이하 일 경우 는 예외 로직을 처리하는 시나리오.
            Random random = new Random();
            
            try
            {
                if (random.Next(0,11) <= 5) // 0 이상 11 미만.
                {
